...
def threes(n):
    ...
    '''
    Returns a list of all numbers from 0 to n inclusive that contain 3.
...
def small_words(text):
    ...
    '''
    Returns a list of all words in the input text  less than 5 characters.
...
def lengths(strings):
    '''
    Given list of strings, return list of the lengths of corresponding strings.
